...
<div class="mejoreshoteles">
	<h1>Los mejores hoteles en Guatemala</h1><div class="linea-horizontal"></div>
<ul><?php
$args = array( 'posts_per_page' => 3, 'offset'=> 0, 'category' => 16 );
...
<div class="top-sitiosturisticos">
	<h1>Turismo en Guatemala</h1><div class="linea-horizontal"></div>
<ul><?php $args = array( 'posts_per_page' => 6, 'offset'=> 0, 'category' => 17 );
$myposts = get_posts( $args );
foreach ( $myposts as $post ) : setup_postdata( $post ); ?>
<li><a href="<?php the_permalink(); ?>">
<article><h2>> <?php the_title(); ?></h2>
