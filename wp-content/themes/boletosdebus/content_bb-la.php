...
<div class="traveldetail">
	<ul>
		...
		<li><h1>servicios</h1>
			<article><?php the_field('servicios'); ?>
...
<div class="mejoreshoteles">
	<h1>Los mejores hoteles en Los Angeles</h1><div class="linea-horizontal"></div>
<ul><?php
$args = array( 'posts_per_page' => 3, 'offset'=> 0, 'category' => 22 );
...
<a href="?cat=16" class="vertodos">ver todos los hoteles</a>
</div>
<!-- ----------------- Fin Los mejores hoteles ---------------------- -->

<!-- ----------------- Top sitios turisticos -------------------------- -->
<div class="top-sitiosturisticos">
	<h1>Turismo en Los Angeles</h1><div class="linea-horizontal"></div>
<ul><?php $args = array( 'posts_per_page' => 6, 'offset'=> 0, 'category' => 23 );
$myposts = get_posts( $args );
foreach ( $myposts as $post ) : setup_postdata( $post ); ?>
<li><a href="<?php the_permalink(); ?>">
<article><h2>> <?php the_title(); ?></h2>
