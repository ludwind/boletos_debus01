...
<div class="mejoreshoteles">
	<h1>Autos en Costa Rica</h1><div class="linea-horizontal"></div>
<ul><?php
$args = array( 'posts_per_page' => 3, 'offset'=> 0, 'category' => 32 );
...
<a href="?cat=32" class="vertodos">ver todos los autos</a>
</div>
...
<ul><?php $args = array( 'posts_per_page' => 7, 'offset'=> 0, 'category' => 35 );
$myposts = get_posts( $args );
foreach ( $myposts as $post ) : setup_postdata( $post ); ?>
<li><a href="<?php the_permalink(); ?>">
<article><h2>> <?php the_title(); ?></h2>
...
<a href="?cat=35" class="vertodos2">ver todos los sitios turisticos</a>
</div>
<!-- ----------------- Fin Los mejores hoteles ---------------------- -->
<div class="espaciadorhome"></div>
