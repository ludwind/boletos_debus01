...
<div class="mejoreshoteles">
	<h1>Autos en honduras</h1><div class="linea-horizontal"></div>
<ul><?php
$args = array( 'posts_per_page' => 3, 'offset'=> 0, 'category' => 25 );
...
<a href="?cat=25" class="vertodos">ver todos los autos</a>
</div>
...
<ul><?php $args = array( 'posts_per_page' => 7, 'offset'=> 0, 'category' => 19 );
$myposts = get_posts( $args );
foreach ( $myposts as $post ) : setup_postdata( $post ); ?>
<li><a href="<?php the_permalink(); ?>">
<article><h2>> <?php the_title(); ?></h2>
...
<a href="?cat=19" class="vertodos2">ver todos los sitios turisticos</a>
</div>
<!-- ----------------- Fin Los mejores hoteles ---------------------- -->
<div class="espaciadorhome"></div>
