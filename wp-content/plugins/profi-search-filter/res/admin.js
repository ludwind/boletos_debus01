jQuery( document ).ready( function(){
	...
	jQuery( document ).on( 'click', '.field.filter>div', function(){
		...
		if( attr.type != 'date' && attr.type != 'btnsearch' && attr.type != 'btnreset' && attr.type != 'fulltext' && attr.type != 'orderby' && attr.type != 'map' )
		...
		if( attr.type == 'select' || attr.type == 'checkbox' || attr.type == 'radiobox' ){
			...
			var others_datasource = '<optgroup label="' + objectL10n.others + '"><option value="others[author]">' + objectL10n.author + '</option></optgroup>';
